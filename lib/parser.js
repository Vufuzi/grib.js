...
var sectionParsers = {
  ...
  */
  ...
  6: function(binary, byteLength) {
    ...
    if (rv.indicator == 0) {
      rv.data = binary.subarray(6, byteLength);
    }

    return rv;
  },
  // SECTION 7 - DATA SECTION
  7: function (binary, byteLength) {
    var rv = {};
...
var gridParsers = {
  ...
  10: function(binary) { var rv={};
    ...
    rv.ni = binary.readUInt32BE(30);
    rv.nj = binary.readInt32BE(34);
    rv.la1 = binary.readInt32BE(38);
    rv.lo1 = binary.readInt32BE(42);
    rv.resolutionAndComponentFlags = binary.readUInt8(46);
    rv.lad = binary.readInt32BE(47);
    rv.la2 = binary.readInt32BE(51);
    rv.lo2 = binary.readInt32BE(55);
    rv.scanningMode = binary.readUInt8(59);
    rv.gridOrientation = binary.readUInt32BE(60);
    rv.di = binary.readInt32BE(64);
    rv.dj = binary.readInt32BE(68);
